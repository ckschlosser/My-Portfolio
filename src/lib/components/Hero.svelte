...
<section class="flex flex-col pt-0" id="hero">
	...
	<div>
		<p class="max-w-xl text-cream mt-6">
			I'm a front end web developer specializing in building responsive web applications. I'm
			currently focusing on growing in my skills and building up my resume with all different types
			of projects!
		</p>
	</div>
	<div>
		<ul class="flex gap-x-10 mt-10">
