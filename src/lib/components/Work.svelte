		...
		<li class="grid grid-cols-12 mb-24 gap-x-3">
			<div class="col-start-7 col-span-6 row-span-full text-right z-10">
				...
				<h3 class="mb-4 text-2xl font-bold text-cream">
					<a href="https://tasklist-cs.netlify.app/" target="_blank">ToDo List</a>
				</h3>
			...
			<div class="col-start-1 col-span-7 row-span-full z-0">
				<a href="https://tasklist-cs.netlify.app/" target="_blank"
					><div><img class="rounded-lg " src="/src/lib/images/ToDo-List.png" alt="" /></div></a
				>
			</div>
		</li>
	</ul>
